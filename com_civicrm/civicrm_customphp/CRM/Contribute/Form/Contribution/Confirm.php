...
class CRM_Contribute_Form_Contribution_Confirm extends CRM_Contribute_Form_ContributionBase 
{
        ...
        if ($title == 'Give a Gift Membership to the Trinity Forum Society')
          {
            ...
            $fname = $this->_params['onbehalf']['first_name'];
            $lname =$this->_params['onbehalf']['last_name'];
           ...
           if ($title == 'Give a Gift Subscription to the Trinity Forum Society')
          {
            ...
            $session->set( 'giftfname', $fname);
            $session->set( 'giftlname', $lname);
          $profileId = CRM_Core_DAO::getFieldValue( 'CRM_Core_DAO_UFGroup', 'gift_subscription', 'id', 'name' );
    ...
    public function postProcess( )
    {
        ...
        if ( CRM_Utils_Array::value( 'hidden_onbehalf_profile', $this->_params ) ) {
            ...
            if ($title == 'Give a Gift Subscription to the Trinity Forum Society') {
                   ...
                   if ($title == 'Give a Gift Member to the Trinity Forum Society') {
     			 $orgFields = array('first_name', 'last_name');
                   }
                  else {
        ...
        if (($title != 'Give a Gift Membership to the Trinity Forum Society') || ($title != 'Give a Gift Subscription to the Trinity Forum Society')) {
        ...
        if ( isset( $params['hidden_onbehalf_profile'] ) && isset( $behalfOrganization['organization_name'] ) ) {
	     ...
	     if ($title == 'Give a Gift Membership to the Trinity Forum Society') {
               ...
               $ufFields = array( );
                ...
                self::processGiftSubscription( $behalfOrganization, $contactID, $this->_values, 
                                               $this->_params, $ufFields );
              }
        ...
        if ( $processMembership ) {
            ...
            if ( is_array( $paymentParams['onbehalf'] ) && !empty( $paymentParams['onbehalf'] ) ) {
             ...
             if (($title == 'Give a Gift Membership to the Trinity Forum Society') || ($title == 'Give a Gift Membership to the Trinity Forum Society')) {
    ...
    static function processGiftMembership( &$behalfOrganization, &$contactID, &$values, &$params, $fields = null) {
     ...
     static function processGiftSubscription( &$behalfOrganization, &$contactID, &$values, &$params, $fields = null) {
        ...
        $relType->name_a_b = 'Gift Subscription Donor';
        $relType->find(true);
        $relTypeId = $relType->id;
