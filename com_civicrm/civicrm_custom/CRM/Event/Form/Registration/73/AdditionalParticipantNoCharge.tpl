     ...
     <span class="crm-marker" title="This field is required.">*</span>
                ...
                <div class="content">
                    ...
                    <div class="price-set-row">
                                                                                                                                    <span class="price-set-option-content"><input price="[&quot;price_7&quot;,&quot;0|1|&quot;]" value="19" type="radio" id="CIVICRM_QFID_19_10" name="price_7" checked="checked" class="form-radio" /><label for="CIVICRM_QFID_19_10">No Charge Ticket&nbsp;-&nbsp;$ 0.00</label></span>
