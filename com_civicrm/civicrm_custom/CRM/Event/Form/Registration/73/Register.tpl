...
{if $form.additional_participants.html}
    <div class="crm-section additional_participants-section" id="noOfparticipants">
        ...
        <div class="content">
            ...
            <span class="description">{ts}buying individual tickets for. If you are registering additional people, you will be able to enter their registration information after you complete this page and click &quot;Continue&quot;.{/ts}</span>
        </div>
        <div class="clear"></div>
    </div>
{/if}
...
<script type="text/javascript">
    ...
    cj("#participant_status").change( function( ) {
        showHideFees( );
    });
