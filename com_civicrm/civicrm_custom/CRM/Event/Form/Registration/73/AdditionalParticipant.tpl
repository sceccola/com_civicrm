...
<div class="crm-block crm-event-additionalparticipant-form-block">
     <fieldset id="priceset" class="crm-group priceset-group"><legend>Founders' Gala Donation</legend>
     	 <div id="priceset" class="crm-section price_set-section">
              
                                <div class="crm-section Please_choose_a_sponsorship-section">
                                          <div class="label"><label>  Please choose a sponsorship
     <span class="crm-marker" title="This field is required.">*</span>
</label></div>
                <div class="content">

                    <div class="price-set-row">
                                                                                                                                    <span class="price-set-option-content"><input price="[&quot;price_7&quot;,&quot;0|1|&quot;]" value="19" type="radio" id="CIVICRM_QFID_19_10" name="price_7" checked="checked" class="form-radio" /><label for="CIVICRM_QFID_19_10">Individual Ticket&nbsp;-&nbsp;$ 500.00</label></span>
