...
{else}
    {include file="CRM/Contribute/Form/Contribution/17/MembershipBlock.tpl" context="makeContribution"}
...
{/if}
    ...
    {if $is_for_organization} 
        {include file=CRM/Contribute/Form/Contribution/17/GiftMember.tpl} 
    {/if} 
		...
		{if $form.honor_type_id.html}
		    <div class="crm-section {$form.honor_type_id.name}-section">
				<div class="content" >
					...
					<div class="description">{ts}Please xxx the name, and / or email address of the person you are honoring.{/ts}</div>
				</div>
		    </div>
		{/if}
